                  ...
                  <div className="block w-[90%] h-[90%] md:w-[40%] md:h-[40%] font-semibold text-slate-600 my-auto ml-8 text-xl">
                    ...
                    <div className="text-base font-bold text-slate-600 mt-4 gap-2">
                      <p className="text-sm font-normal text-slate-500">
                        Bir aracın kaza geçirmesi, yanması, çalınması veya
                        çalınmaya teşebbüs edilmesi sonucu oluşabilecek
                        zararları güvence altına alan bir sigorta sözleşmesi.
                        Trafik sigortasından farklı olarak, poliçe sahibinin
                        kendi aracının hasarını da kısmen veya tamamen karşılar.
                        KISACASI KASKO KENDİ ARACINIZDA MEYDANA GELECEK
                        HASARLARI KARŞILAYAN SİGORTA TÜRÜDÜR.
                      </p>
