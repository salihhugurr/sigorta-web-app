...
const OTATrip = (props: Props) => {
  const [form, setForm] = useState({
    name: "",
    surname: "",
    email: "",
    phone: "",
    subject:"Seyahat Sigortası",
    ID: "",
    tax:"",
    place: "",
    person: "",
  ...
  return (
    ...
    >
      <Banner title="Online Teklif Al - Seyahat" />
      ...
      <p className="m-6">Seyahat Bilgileri</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 m-6">
        <div className="relative m-2 lg:m-0">
          ...
          <input
            ...
            onChange={changeHandle}
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Seyahat Edilecek Bölge"
          />
        </div>
        <div className="relative m-2 lg:m-0">
          <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
      ...
      <p className="m-6">Başlangıç-Bitiş Tarihi</p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 m-6">
        <div className="relative m-2 lg:m-0">
          <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            <CalendarIcon
