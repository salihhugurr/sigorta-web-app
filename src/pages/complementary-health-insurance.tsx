...
const ComplementaryHealth = (props: Props) => {
        const [form, setForm] = useState({
          name: "",
          email: "",
          phone: "",
          subject: "Tamamlayıcı Sağlık Sigortası"
        });
          ...
          <div className="flex h-full w-full">
            <div className="block w-full h-full">
              <div className="block w-full">
                <Banner title="Tamamlayıcı Sağlık Sigortası" />
                  ...
                  <div className="block w-[90%] h-[90%] md:w-[40%] md:h-[40%] font-semibold text-slate-600 my-auto ml-8 text-xl">
                    ...
                    <div className="text-base font-bold text-slate-600 mt-4 gap-2">
                      ...
                      <p className="text-sm font-normal text-slate-500">
                        Sigortalının, Sosyal Güvenlik Kurumu (SGK) ile anlaşmalı
                        özel sağlık kuruluşlarından alacağı sağlık hizmetleri
                        için ödeyeceği fark ücretlerini ürün özel ve genel
                        şartları kapsamında karşılayan bir sağlık sigortası
                        ürünüdür.
                      </p>
