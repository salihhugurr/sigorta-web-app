...
const DaskInsurance = (props: Props) => {
        const [form, setForm] = useState({
          name: "",
          email: "",
          phone: "",
          subject: "DASK Sigortası"
        });
                ...
                <div className="block md:flex w-full justify-center md:py-32 py-8">
                  ...
                  <div className="block w-[90%] h-[90%] md:w-[40%] md:h-[40%] font-semibold text-slate-600 my-auto ml-8 text-xl">
                    ...
                    <div className="text-base font-bold text-slate-600 mt-4 gap-2">
                      DOĞAL AFET SİGORTASI "DASK" NEDİR ?
                      <p className="text-sm font-normal text-slate-500">
                        Doğal afet sigortası ülkemizde zorunlu tutulan sigorta
                        türlerindendir. DASK, Zorunlu Deprem Sigortası ile
                        depremin ve deprem sonucu meydana gelen yangın, infilak,
                        tsunami ve yer kaymasının doğrudan neden olacağı maddi
                        zararları, poliçenizde belirtilmiş limitler dahilinde
                        nakit olarak karşılar. Binanız tamamen ya da kısmi
                        olarak zarar görmüş olsa da teminat altındadır.
                      </p>
