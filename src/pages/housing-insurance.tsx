                  ...
                  <div className="block w-[90%] h-[90%] md:w-[40%] md:h-[40%] font-semibold text-slate-600 my-auto ml-8 text-xl">
                    ...
                    <div className="text-base font-bold text-slate-600 mt-4 gap-2">
                      ...
                      <p className="text-sm font-normal text-slate-500">
                        Konut sigortası; sigortalanan konutu teminat kapsamına
                        göre yangın, deprem, sel, su baskını, dolu, hırsızlık,
                        cam kırılması ve daha birçok olası duruma karşı güvence
                        altına alan sigorta türüdür. DOĞAL AFET SİGORTASI ( DASK
