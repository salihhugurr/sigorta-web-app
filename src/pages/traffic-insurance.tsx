...
const TrafficInsurance = (props: Props) => {
      const [form, setForm] = useState({
        name: "",
        email: "",
        phone: "",
        subject:"Trafik Sigortası",
      });
            ...
            <div className="block w-[90%] h-[90%] md:w-[40%] md:h-[40%] font-semibold text-slate-600 my-auto ml-8 text-xl">
              ...
              <div className="text-base font-bold text-slate-600 mt-4 gap-2">
                ...
                <p className="text-sm font-normal text-slate-500">
                  Zorunlu trafik sigortası, her araç sahibinin yaptırmasının
                  zorunlu olduğu bir araç sigortasıdır. Trafik sigortası,
                  trafikte meydana gelebilecek kaza sonucunda karşı tarafın
                  maddi ve bedensel zararlarının karşılanmasını sağlar.
                </p>
                Zorunlu trafik sigortası ne işe yarar?
                <p className="text-sm font-normal text-slate-500">
                  Zorunlu trafik sigortası sigortalının trafıkte iken 3.
                  şahışlara vereceği zararları minimize ederek kazada meydana
                  gelen maddi ve manevi kayıpları teminatlar dahilinde sigortalı
                  adına 3. şahıslara öder. Bunun ile birlikte sigortalının maddi
              ...
              <p className="m-4 font-bold text-slate-900">Hizmet Talep Formu</p>
