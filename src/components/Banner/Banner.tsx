...
const Banner = ({title}: Props) => {
  return (
    <div className="relative w-full isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 py-2.5 px-6 sm:px-3.5 sm:before:flex-1">
      <svg
        viewBox="0 0 577 310"
        aria-hidden="true"
      ...
      <div className="flex p-10 flex-wrap items-center gap-y-2 text-2xl font-bold gap-x-4">
        <img className="h-10 w-10 " src="/logo.svg" alt="logo" />

        <p className="block text-3xl leading-6 text-gray-900">
